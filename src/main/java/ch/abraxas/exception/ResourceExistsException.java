...
/**
 * A ResourceExistsException is used to signal a conflicting behavior in case a resource modification failed because of
 * the resource exists whereas its existence was not expected.
 *
